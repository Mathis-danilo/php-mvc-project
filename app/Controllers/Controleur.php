...
class Controleur extends BaseController
{
	...
	{
		if (isset($_POST['etape']) && isset($_POST['kilometres']) && isset($_POST['nuitees']) && isset($_POST['repas']) && isset($_POST['date']) && isset($_POST['libelle']) && isset($_POST['montant'])) {
			$this->renseignement();
		} else if (isset($_GET['action']) && $_GET['action'] == 'RenseignerFicheFrais') {
			$this->renseignerFiche();
		} else if (isset($_GET['action']) && $_GET['action'] == 'ConsulterFichesFrais') {
			$this->consulterFiche();
